...
import styles from "../styles/wmreact-base.css";
import Accordion from "./accordion";

export default class WmreactBase extends React.Component {
  render() {
...
WmreactBase.displayName = "WmreactBase";

WmreactBase.propTypes = {
  data: propTypes.array
};

WmreactBase.defaultProps = { };
